...
4. 近目标精密伺服：在末端进入目标附近后进行细粒度位置修正和动作平滑，提升最终误差与 Hold@5mm。
...
|:---:|:---:|---:|---:|---:|
| 固定目标 | 本文完整方法 | 0.019 mm | 1.000 | 1.000 |
| 随机目标 | 本文完整方法 | 0.207 mm | 1.000 | 1.000 |
...
|:---|---:|---:|:---:|
| 末端加速度 RMS | 0.856 | 4.752 | 降低 |
| 末端加速度峰值 | 5.373 | 28.544 | 降低 |
| 末端加速度峰峰值 | 5.165 | 30.699 | 降低 |
| 末端 jerk RMS | 16.569 | 99.267 | 降低 |
| 动作变化量 | 0.014 | 0.036 | 降低 |
| 振动指数 | 0.493 | 2.739 | 降低 |
...
| 完整方法 | 0.207 mm | 1.000 | 0.856 | 5.165 | 16.569 | 0.0143 |
...
3. 融合稳定性约束与近目标精密伺服，在保证 5 mm 定位精度的同时降低末端振动和动作变化量，实现高精度与高稳定性的协同提升。
