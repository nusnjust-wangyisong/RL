...
创新点可以表述为：面向高精度机械臂 Reach 的 TD3-HER 自适应课程强化学习方法，并在近目标接触扰动下引入稳定性约束，使策略不仅提高 5 mm 到达成功率，还降低受迫振动响应。TQC 作为强基线加入，若 TQC 结果更好，可以在论文中把 TQC 作为最优 off-policy baseline，与本文融合策略对比。
